            ...
            <img
              src={
                typeof data.image === "string"
                  ? data.image
                  : (data.image instanceof Blob ? URL.createObjectURL(data.image) : "")
              }
              alt="user-image"
      ...
      {fields.map((field) => {
        ...
        return (
          <div key={field.key} className="space-y-1 mt-5">
            ...
            <input
              className="mt-1 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-colors text-sm"
